<template>
  <div id="app">
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
      <button id="btn-all" class="btn btn-dark">&#9776;</button>
      <svg
      ...
      <div id="search-bar" class="input-group-prepend">
        <div class="dropdown" id="dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a @click="handleDropdown($t('header-search-1'))" class="dropdown-item" href="#">{{
              $t("header-search-1")
            }}</a>
            <a @click="handleDropdown($t('header-search-2'))" class="dropdown-item" href="#">{{
              $t("header-search-2")
            }}</a>
            <a @click="handleDropdown($t('header-search-3'))" class="dropdown-item" href="#">{{
              $t("header-search-3")
            }}</a>
            <a @click="handleDropdown($t('header-search-4'))" class="dropdown-item" href="#">{{
              $t("header-search-4")
            }}</a>
          </div>
        </div>
        <form class="form-inline">
          <input
            id="searchField"
            @keydown="searchTrigger"
            class="form-control mr-sm-2"
            type="search"
            :placeholder="$t('header-searchimdb')"
            aria-label="Search"
          />
        </form>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
      ...
      <div class="row" style="margin-left: 10px; margin-right: 10px">
        <svg
          v-if="isLoggedIn"
          style="margin-top: 3px; margin-right: 5px; color: white"
          xmlns="http://www.w3.org/2000/svg"
          width="22.5"
          height="22.5"
          fill="currentColor"
        ...
        <p id="username-text" style="color: aliceblue"></p>
      </div>

      <button @click="login()" v-if="!isLoggedIn" id="btn-header" type="button" class="btn btn-dark">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="16"
          height="16"
      ...
      <button type="button" class="btn btn-warning">{{ $t("header-useapp") }}</button>
      <button id="btn-imdbpro" type="button" class="btn btn-dark">
        <svg
      ...
      <button @click="handleWatchlist()" id="btn-watchlist" class="btn btn-dark">
        <svg
          width="24"
          height="24"
          xmlns="http://www.w3.org/2000/svg"
      ...
      <div id="btn-language" class="dropdown">
        <button
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a @click="handleLanguage('EN')" class="dropdown-item" href="#">EN</a>
          <a @click="handleLanguage('TR')" class="dropdown-item" href="#">TR</a>
        </div>
      </div>
    </nav>
  </div>
...
export default {
  ...
  methods: {
    ...
    handleDropdown(type) {
      ...
      this.emitter.emit("searchType", this.searchType);
    },

    async searchTrigger(event) {
      ...
      this.emitter.emit("searchKeys", this.keysPressed);
    },
